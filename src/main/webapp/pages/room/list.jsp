    ...
    <div class="layui-row">
        <form class="layui-form layui-col-md12 we-search">
            ...
            <div class="layui-inline">
                <input type="text" name="username" placeholder="房间号" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-inline">
                <input type="text" name="username" placeholder="负责人" autocomplete="off" class="layui-input">
            </div>
